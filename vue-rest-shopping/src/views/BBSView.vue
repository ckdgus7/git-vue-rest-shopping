      ...
      <div id="container">
        ...
        <article id="bo_v" style="width:100%">
          ...
          <section id="bo_v_info">
            ...
            <div id="bo_v_top">
              <ul class="btn_bo_user bo_v_com">
                ...
                <li>
                  <a href="" class="btn_b01 btn" title="답변">
                  <i class="fa fa-reply" aria-hidden="true"></i><span class="sound_only">답변</span></a>
                </li>
                <li>
          ...
          <aside id="bo_vc_w" class="bo_vc_w">
            <h2>댓글쓰기</h2>
            <form name="fviewcomment" id="fviewcomment" action="http://jswrap.ivyro.net/bbs/write_comment_update.php" onsubmit="return fviewcomment_submit(this);" method="post" autocomplete="off">
